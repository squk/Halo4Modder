...
namespace HaloReach3d.Raw.Models
{
    ...
    public struct MarkerGroup
    {
        ...
        {
            Name = map.String_Table.StringItems[map.String_Table.GetStringItemIndexByID(map, er.ReadInt32())].Name;
            int count = er.ReadInt32();
            int pointer = er.ReadInt32() - map.Map_Header.mapMagic;
    ...
    public class ModelFunctions
    {
        public static ModelInfo GetModelInfo(HaloMap Map, int TagIndex)
        {
            ...
            // Get our Name
            Map.OpenIO();
            Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset);
            mi.Name = Map.String_Table.StringItems[(Map.String_Table.GetStringItemIndexByID(Map, Map.IO.In.ReadInt32()))].Name;

            // Get our Region info first
            Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 12);
            ...
            int regionPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
            ...
            for (int x = 0; x < regionCount; x++)
            {
                ...
                region.Name = Map.String_Table.StringItems[Map.String_Table.GetStringItemIndexByID(Map, Map.IO.In.ReadInt32())].Name;
                int permutationCount = Map.IO.In.ReadInt32();
                int permutationPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                {
                    //if (Map.Halo_Map_Version == HaloMap.HaloMapVersion.Halo3ODST)
                    //    Map.IO.SeekTo(permutationPointer + (24 * y));
                    //else if (Map.Halo_Map_Version == HaloMap.HaloMapVersion.HaloReach)
                    //    Map.IO.SeekTo(permutationPointer);
                    Permutation perm = new Permutation();
                    perm.Name = Map.String_Table.StringItems[Map.String_Table.GetStringItemIndexByID(Map, Map.IO.In.ReadInt32())].Name;
                ...
                // Get our nodes
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 48);
                int nodeCount = Map.IO.In.ReadInt32();
                int nodePointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 60);
                int markerGroupCount = Map.IO.In.ReadInt32();
                int markerGroupPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                // Read our shaders
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 72);
                ...
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 104);
                int modelPartCount = Map.IO.In.ReadInt32();
                int modelPartPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                for (int x = 0; x < modelPartCount; x++)
                {
                    ...
                    int submeshPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                    ...
                    int subsetPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 116);
                int boundingBoxCount = Map.IO.In.ReadInt32();
                int boundingBoxPointer = Map.IO.In.ReadInt32() - Map.Map_Header.mapMagic;
                ...
                // Get our raw ID now
                Map.IO.SeekTo(Map.Index_Items[TagIndex].Offset + 224);
        ...
        public static void WriteAllToObj(string ExtractDirectory, ModelInfo Mi)
        {
            for (int x = 0; x < Mi.ModelParts.Count; x++)
            {
                ...
                sw.WriteLine("# ----- ----------------------------------");
                sw.WriteLine("# Halo Reach Model - Extracted with Ascension");
                sw.WriteLine("# ----------------------------------------");
                ...
                if (treeView.Nodes[x].Checked)
                {
                    ...
                    for (int y = 0; y < treeView.Nodes[x].Nodes.Count; y++)
                    {
                        ...
                        if (treeView.Nodes[x].Nodes[y].Checked)
                        {
                            ...
                            for (int i = 0; i < Mi.Regions[x].Permutations[y].LODs.Count; i++)
                            {
                                if (Mi.Regions[x].Permutations[y].LODs[i] != -1)
                                {
                                    CorrectLOD = i;
                                    break;
                                }
                            }
                            //if (Mi.ModelParts[Mi.Regions[x].Permutations[y].LODs[(int)LOD]] != -1)
                            //    ModelPart part = Mi.ModelParts[Mi.Regions[x].Permutations[y].LODs[(int)LOD]];
                            ModelPart part = Mi.ModelParts[Mi.Regions[x].Permutations[y].LODs[CorrectLOD]];
