...
namespace HaloReach3d.Raw.Bitmaps
{
    ...
    public struct BitmapInfo
    {
        ...
        public BitmapInfo(HaloMap Map, int TagIndex)
        {
            ...
            map.IO.SeekTo(map.Index_Items[TagIndex].Offset + 124);
            ...
            // Get our raw ID now
            map.IO.SeekTo(map.Index_Items[TagIndex].Offset + 168);
            ...
            // Get our raw ID now
            map.IO.SeekTo(map.Index_Items[TagIndex].Offset + 180);
            count = map.IO.In.ReadInt32();
            pointer = map.IO.In.ReadInt32() - map.Map_Header.mapMagic;
        ...
        public Bitmap GeneratePreview(int BitmapIndex)
        {
            ...
            // How about a, let the program try, and if it fails, instead of ERROR PREVIEWING, just say No Preview Available - Nathan
        ...
        public Bitmap GeneratePreview(int BitmapIndex, TextureFormat textureFormat)
        {
            ...
            bitmapData.Format = textureFormat;
